    ...
    <div className="select-none pb-5">
      ...
      >
        ...
        >
          ...
          />
          <p className="dream-text text-7xl text-white font-bold ">
            드림과 함께 만들어 가는 세상
          </p>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col items-center gap-20 justify-center w-full h-full">
          ...
          <img
            src={earthSick}
            alt="지구가아파요"
            className="sec-2-img w-[430px] h-[338px]"
          />
        </div>
      </div>
      ...
      <div tabIndex={0} className="snap-start w-screen h-screen bg-white">
        <div className="flex flex-col items-center justify-center gap-16 w-full h-full">
          ...
          <p className="sec-4-text-t text-6xl">
            "지구를 되살리기 위한 사업을 합니다"
          </p>
          <img
            src={earthClean}
            alt="건강한지구"
            className="sec-4-img w-[458px] h-[335px]"
          />
      ...
      <div tabIndex={0} className="snap-start w-screen h-screen">
